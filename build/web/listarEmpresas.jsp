    ...
    <body>
        ...
        <div class="global-div">
            ...
            <div class="destaques-div">
                <h5>Listagem de Empresas - <a href="CadastraEmpresa.jsp">
                        <img src="images/adicionar.png" alt="Adicionar" style="width:24px;height:24px;border:0;">
                    </a></h5>                
                    <logic:present name="ListarEmpresasActionForm" property="empresas">
                    <table  class="table-style-three" style="text-align: center" >
                        ...
                        <tbody>
                            <logic:iterate name="ListarEmpresasActionForm" property="empresas" id="empresa">
                                <tr>
                                    <td><bean:write name="empresa" property="id"/></td>
                                    <td><bean:write name="empresa" property="nome"/></td>
                                    <td><bean:write name="empresa" property="cnpj"/></td>

                                    <td><a href="alterarEmpresa1.do?id=<bean:write name="empresa" property="id"/>">Alterar</a></td>
                                    <td><a href="removerEmpresa.do?id=<bean:write name="empresa" property="id"/>">Remover</a></td>
                                </tr>                        
                            </logic:iterate>
                        </tbody>
                    </table>
