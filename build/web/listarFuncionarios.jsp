    ...
    <body>
        ...
        <div class="global-div">
            ...
            <div class="destaques-div">
                <h5>Listagem de Funcionários - <a href="CadastraFuncionario.jsp">
                        ...
                        <tbody>
                            <logic:iterate name="ListarFuncionariosActionForm" property="funcionarios" id="funcionario">
                                <tr>
                                    ...
                                    <td><bean:write name="funcionario" property="departamento.nome"/></td>
                                    <td><a href="alterarFuncionario1.do?id=<bean:write name="funcionario" property="id"/>">Alterar</a></td>
                                    <td><a href="removerFuncionario.do?id=<bean:write name="funcionario" property="id"/>">Remover</a></td>
                                </tr>                        
                            </logic:iterate>
                        </tbody>
                    </table>
