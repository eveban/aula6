    ...
    <body>
        <div class="global-div">
            ...
            <div class="destaques-div">
                ...
                <html:form action="/inserirEmpresa" method="POST">


                    <div class="col-2">
                        <label>
                            Nome:
                            <html:text  property="nome" name="CadastraEmpresaActionForm" tabindex="1"/>
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            CNPJ:
                            <html:text name="CadastraEmpresaActionForm" property="cnpj" tabindex="2" />
                        </label>
                    </div>
