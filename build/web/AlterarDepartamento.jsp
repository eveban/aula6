    ...
    <body>
        <div class="global-div">
            ...
            <div class="destaques-div">
                ...
                <html:form action="alterarDepartamento2" method="POST">


                    <div class="col-2">
                        <label>
                            Nome:
                            <html:text  property="nome" name="AlteraDepartamentoActionForm" tabindex="1"/>
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            Local:
                            <html:text name="AlteraDepartamentoActionForm" property="local" tabindex="2" />
                        </label>
                    </div>
                    <div class="col-3">
                        <label>
                            Descrição:
                            <html:text name="AlteraDepartamentoActionForm" property="descricao" tabindex="3" />
                        </label>
                    </div>
