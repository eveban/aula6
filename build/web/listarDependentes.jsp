    ...
    <body>
        ...
        <div class="global-div">
            ...
            <div class="destaques-div">
                <h5>Listagem de Dependentes - <a href="CadastraDependente.jsp">
                        <img src="images/adicionar.png" alt="Adicionar" style="width:24px;height:24px;border:0;">
                    </a></h5>                
                    <logic:present name="ListarDependentesActionForm" property="dependentes">
                    <table  class="table-style-three" style="text-align: center" >
                        ...
                        <tbody>
                            <logic:iterate name="ListarDependentesActionForm" property="dependentes" id="dependente">
                                <tr>
                                    <td><bean:write name="dependente" property="funcionario.nome"/></td>
                                    <td><bean:write name="dependente" property="nome"/></td>
                                    <td><bean:write name="dependente" property="rg"/></td>
                                    <td><bean:write name="dependente" property="cpf"/></td>
                                    <td><bean:write name="dependente" property="parentesco"/></td>
                                    <td><a href="alterarDependente1.do?id=<bean:write name="dependente" property="id"/>">Alterar</a></td>
                                    <td><a href="removerDependente.do?id=<bean:write name="dependente" property="id"/>">Remover</a></td>
                                </tr>                        
                            </logic:iterate>
                        </tbody>
                    </table>
