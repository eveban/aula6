    ...
    <body>
        <div class="global-div">
            ...
            <div class="destaques-div">
                ...
                <html:form action="/inserirFolha" method="POST">

                    <div class="col-2">
                        <label>
                            Funcionário: 
                            <html:select name="CadastraFolhaActionForm" property="funcionario">
                                <html:option value="0">--Select Funcionario--</html:option>
                                <html:optionsCollection name="CadastraFolhaActionForm" property="funcionarios" label="nome" value="id"/>
                            </html:select>
                        </label>
                    </div>
                    ...
                    <div class="col-2">
                        <label>
                            ...
                            <html:select name="CadastraFolhaActionForm" property="empresa">
                                <html:option value="0">--Select Empresa--</html:option>
                                <html:optionsCollection name="CadastraFolhaActionForm" property="empresas" label="nome" value="id"/>
                            </html:select>
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            Data Pagamento:
                            <html:text  property="datapagamento" name="CadastraFolhaActionForm" tabindex="1"/>
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            Salário:
                            <html:text  property="salario" name="CadastraFolhaActionForm" tabindex="1"/>
                        </label>
                    </div>
                    ...
                    <div class="col-2">
                        <label>
                            INSS:
                            <html:text  property="inss" name="CadastraFolhaActionForm" tabindex="1"/>
                        </label>
                    </div>
                    ...
                    <div class="col-2">
                        <label>
                            Sindicato:
                            <html:text name="CadastraFolhaActionForm" property="sindicato" tabindex="2" />
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            Ajuda de Custo
                            <html:text name="CadastraFolhaActionForm" property="ajudacusto" tabindex="3" />
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            PLR 1/12: 
                            <html:text name="CadastraFolhaActionForm" property="plr" tabindex="4" />
                        </label>
                    </div>
                    ...
                    <div class="col-2">
                        <label>
                            Decimo 1/12:
                            <html:text name="CadastraFolhaActionForm" property="decimo" tabindex="5" />
                        </label>
                    </div>
                    ...
                    <div class="col-2">
                        <label>
                            Periodo:
                            <html:text name="CadastraFolhaActionForm" property="periodo" tabindex="6" />
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            Férias 1/12:
                            <html:text name="CadastraFolhaActionForm" property="ferias" tabindex="6" />
                        </label>
                    </div>
                    ...
                    <div class="col-2">
                        <label>
                            Salário Familia? 
                            <html:select name="CadastraFolhaActionForm" property="salariofamilia">
                    ...
                    <table border="0" style="width: 100%">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="submit" value="Cadastrar" class="login-submit-form"></td>
