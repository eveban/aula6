    ...
    <body>
        <div class="global-div">
            ...
            <div class="destaques-div">
                ...
                <html:form action="/inserirDependente" method="POST">

                    <div class="col-3">
                        <label>
                            Funcionario

                            <html:select name="CadastraDependenteActionForm" property="funcionario">
                                <html:option value="0">--Select Funcionario--</html:option>
                                <html:optionsCollection name="CadastraDependenteActionForm" property="funcionarios" label="nome" value="id"/>
                            </html:select>
                        </label>
                    </div>
                    ...
                    <div class="col-2">
                        <label>
                            Nome:
                            <html:text  property="nome" name="CadastraDependenteActionForm" tabindex="1"/>
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            RG:
                            <html:text name="CadastraDependenteActionForm" property="rg" tabindex="2" />
                        </label>
                    </div>
                    ...
                    <div class="col-3">
                        <label>
                            CPF: 
                            <html:text name="CadastraDependenteActionForm" property="cpf" tabindex="4" />
                        </label>
                    </div>
                    ...
                    <div class="col-3">
                        <label>
                            Parentesco:
                            <html:text name="CadastraDependenteActionForm" property="parentesco" tabindex="5" />
                        </label>
                    </div>
