...
<html>
    ...
    <body>
        <div class="global-div">
            ...
            <div class="destaques-div">
                ...
                <html:form action="/inserirFuncionario" method="POST">
                    ...
                    <div class="col-3">
                        <label>
                            CPF: 
                            <html:text name="InsereFuncionarioActionForm" property="cpf" tabindex="4" />
                        </label>
                    </div>
                    ...
                    <div class="col-3">
                        <label>
                            Pai:
                            <html:text name="InsereFuncionarioActionForm" property="pai" tabindex="5" />
                        </label>
                    </div>
                    ...
                    <div class="col-3">
                        <label>
                            Mãe:
                            <html:text name="InsereFuncionarioActionForm" property="mae" tabindex="6" />
                        </label>
                    </div>
                    ...
                    <div class="col-3">
                        <label>
                            Fumante: 
                            <html:select name="InsereFuncionarioActionForm" property="fumante">
            ...
            <div class="rodape-div"><p>Everson & Leonardo.pt</p></div>
        </div>
    </body>
</html>
