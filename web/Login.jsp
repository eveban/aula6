...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Escola de Engenharia de Piracicaba</title>
    ...
    <body>
        ...
        <div id="logo"> 
            <h1><i>Ling. Programação II Everson/Leonardo</i></h1>
        </div> 
        <section class="stark-login">

            <html:form action="/login">	
                <div id="fade-box"> 
                    <input type="text" name="login" id="username" placeholder="Usuário" required>
