    ...
    <body>
        <div class="global-div">
            ...
            <div class="destaques-div">
                ...
                <html:form action="/inserirDepartamento" method="POST">


                    <div class="col-2">
                        <label>
                            Nome:
                            <html:text  property="nome" name="CadastraDepartamentoActionForm" tabindex="1"/>
                        </label>
                    </div>
                    <div class="col-2">
                        <label>
                            Local:
                            <html:text name="CadastraDepartamentoActionForm" property="local" tabindex="2" />
                        </label>
                    </div>
                    ...
                    <div class="col-3">
                        <label>
                            Descriçao: 
                            <html:text name="CadastraDepartamentoActionForm" property="descricao" tabindex="4" />
                        </label>
                    </div>
