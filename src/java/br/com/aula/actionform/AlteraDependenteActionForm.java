 ...
 * @author everson
 */
public class AlteraDependenteActionForm extends org.apache.struts.action.ActionForm {
    ...
    public AlteraDependenteActionForm() {
        super();
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (getRg() == null || getRg().length() < 1) {
            errors.add("rg", new ActionMessage("error.rg.required"));
        }
        return errors;
    }
}
